...
function Setup() {
  ...
  const onSubmit = async (values: SetupValues) => {
    ...
    if (githubTrimmed && githubTrimmed === debouncedGithub && !githubQuery.isFetching && github?.found === false) {
